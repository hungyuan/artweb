            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                  ...
                  <table width="100%" border="0" cellpadding="5" cellspacing="3">
                   <tr>
                     ...
                     <td class="table_data">
                      <?php
                      do {
                       if (!(strcmp($row_RecsocietyC['c_id'], $row_Recsociety['d_class2']))) {
                ...
                <tr>
                  ...
                  <td class="table_data"><?php echo $row_Recsociety['d_title']; ?></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
                <!-- <tr>
                  <td align="center" bgcolor="#e5ecf6" class="table_col_title">地址</td>
                  <td class="table_data"><?php echo $row_Recsociety['d_class3']; ?></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
                <tr>
                  <td align="center" bgcolor="#e5ecf6" class="table_col_title">電話</td>
                  <td class="table_data"><?php echo $row_Recsociety['d_class4']; ?></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr>
                <tr>
                  <td align="center" bgcolor="#e5ecf6" class="table_col_title">營業時間</td>
                  <td class="table_data"><?php echo $row_Recsociety['d_class5']; ?></td>
                  <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                </tr> -->

                <tr>
                 <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">時間</td>
                 <td class="table_data"><?php echo $row_Recsociety['d_date']; ?></td>
                 <td bgcolor="#e5ecf6">&nbsp;</td>
               </tr>
...
if ((isset($_REQUEST['d_id'])) && ($_REQUEST['d_id'] != "") && (isset($_REQUEST['delsure']))) {
 ...
 while ( $row = mysql_fetch_array($result))
 {
   ...
   $Result1 = mysql_query($deleteSQL, $connect2data) or die(mysql_error());
      ...
      //----------刪除圖片資料到資料庫begin(在主資料前)-----
   $sql="SELECT file_link1 FROM file_set WHERE file_type='societyBanner' AND file_d_id='".$_POST['d_id']."'";
    $result = mysql_query($sql)or die("無法送出".mysql_error( ));
    while ( $row = mysql_fetch_array($result))
    {
        //echo "../".$row[0]."<BR>";
      ...
      $sql="SELECT file_link2 FROM file_set WHERE file_type='societyBanner' AND file_d_id='".$_POST['d_id']."'";
      $result = mysql_query($sql)or die("無法送出".mysql_error( ));
      while ( $row = mysql_fetch_array($result))
      {
        //echo "../".$row[0]."<BR>";
      ...
      $sql="SELECT file_link3 FROM file_set WHERE file_type='societyBanner' AND file_d_id='".$_POST['d_id']."'";
      $result = mysql_query($sql)or die("無法送出".mysql_error( ));
      while ( $row = mysql_fetch_array($result))
      {
        //echo "../".$row[0]."<BR>";
      ...
      $sql="SELECT file_link4 FROM file_set WHERE file_type='societyBanner' AND file_d_id='".$_POST['d_id']."'";
      $result = mysql_query($sql)or die("無法送出".mysql_error( ));
      while ( $row = mysql_fetch_array($result))
      {
        //echo "../".$row[0]."<BR>";
      ...
      $deleteSQL = sprintf("DELETE FROM file_set WHERE file_type='societyBanner' AND file_d_id=%s",
        GetSQLValueString($_REQUEST['d_id'], "int"));
   ...
   $deleteGoTo = "society_list.php?delchangeSort=1&selected1=".$G_selected1."&selected2=".$G_selected2;
