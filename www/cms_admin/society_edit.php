...
$colname_Recsociety = "-1";
if (isset($_GET['d_id'])) {
  $colname_Recsociety = $_GET['d_id'];
}
mysql_select_db($database_connect2data, $connect2data);
$query_Recsociety = sprintf("SELECT data_set.*, class_set.c_title as c_title FROM data_set LEFT JOIN class_set ON data_set.d_class2 =class_set.c_id WHERE d_id = %s", GetSQLValueString($colname_Recsociety, "int"));
...
//banner
$query_RecImageBanner = sprintf("SELECT * FROM file_set WHERE file_d_id = %s AND file_type = 'societyBanner'", GetSQLValueString($colname_RecImage, "int"));
...
if (isset($_SESSION['selected_societyC'])){
	$G_selected1 = $_SESSION['selected_societyC'] = $row_Recsociety['d_class2'];
                   ...
                   <tr>
                     ...
                     <td>
                       <select name="d_class2" id="d_class2">
                         ...
                         do {
                          ?>
                          <option value="<?php echo $row_RecsocietyC['c_id']?>" <?php if (!(strcmp($row_RecsocietyC['c_id'], $row_Recsociety['d_class2']))) {echo "selected=\"selected\"";} ?>><?php echo $row_RecsocietyC['c_title']?></option>
                          <?php
                     ...
                     <tr>
                       ...
                       <td><input name="d_title" type="text" class="table_data" id="d_title" size="80" value="<?php echo $row_Recsociety['d_title']; ?>" /></td>
                       <td bgcolor="#e5ecf6">&nbsp;</td>
                     </tr>

                     <tr>
                       <td align="center" bgcolor="#e5ecf6" class="table_col_title">內容</td>
                       <td><textarea name="d_content" cols="50" rows="30" class="table_data tiny" id="d_content"><?php echo $row_Recsociety['d_content']; ?></textarea></td>
                     ...
                     <tr>
                      ...
                      <td><input name="d_date" type="text" class="table_data" id="d_date" value="<?php echo $row_Recsociety['d_date']; ?>" size="50" /></td>
                      <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                    </tr>
                    <tr>
                     ...
                     <td><label>
                       <select name="d_active" class="table_data" id="d_active">
                         <option value="0" <?php if (!(strcmp(0, $row_Recsociety['d_active']))) {echo "selected=\"selected\"";} ?>>不公佈</option>
                         <option value="1" <?php if (!(strcmp(1, $row_Recsociety['d_active']))) {echo "selected=\"selected\"";} ?>>公佈</option>
                       </select>
                     </label></td>
                     <td bgcolor="#e5ecf6">&nbsp;</td>
                   </tr>
                   ...
                   <tr>
                     ...
                     <td><label>
                       <select name="d_data1" class="table_data" id="d_data1">
                         <option value="0" <?php if (!(strcmp(0, $row_Recsociety['d_data1']))) {echo "selected=\"selected\"";} ?>>不公佈</option>
                         <option value="1" <?php if (!(strcmp(1, $row_Recsociety['d_data1']))) {echo "selected=\"selected\"";} ?>>公佈</option>
                       </select>
                     </label></td>
                     <td bgcolor="#e5ecf6">&nbsp;</td>
                   </tr>
                   ...
                   <!-- <tr>
                    ...
                    <td><?php do { ?>
                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td align="center"><a href="image_edit.php?file_id=<?php echo $row_RecImageBanner['file_id'].'&type=societyBanner'; ?>" class="fancyboxEdit" title="修改圖片"><img src="image/media_edit.gif" width="16" height="16" title="修改圖片"/></a><a href="image_del.php?file_id=<?php echo $row_RecImageBanner['file_id'].'&type=societyBanner'; ?>" class="fancyboxEdit" title="刪除圖片"><img src="image/media_delete.gif" width="16" height="16" title="刪除圖片"/></a></td>
                          <td align="center">&nbsp;</td>
                        </tr>
                      </table>
...
<input name="d_id" type="hidden" id="d_id" value="<?php echo $row_Recsociety['d_id']; ?>" />
<input name="d_sort" type="hidden" id="d_sort" value="<?php echo $row_Recsociety['d_sort']; ?>" />
</form>
...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
 ...
 if($ifFile){
  ...
  //$updateGoTo = "society_list.php?selected1=".$class2."&selected2=".$class3."&changeSort=1&change_num=".$_POST['d_sort']."&now_d_id=".$_POST['d_id']."&totalRows_Recsociety=".$_SESSION['totalRows']."&pageNum=".$_SESSION["ToPage"];
    $updateGoTo = "society_list.php?selected1=".$d_class2."&changeSort=1&change_num=".$_POST['d_sort']."&now_d_id=".$d_id."&totalRows=".$_SESSION['totalRows']."&pageNum=".$_SESSION["ToPage"];
