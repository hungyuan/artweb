                  ...
                  <table width="100%" border="0" cellspacing="3" cellpadding="5">
                   <tr>
                     ...
                     <td width="532"><input name="c_title" type="text" class="table_data" id="c_title" size="50">
                      <input name="c_parent" type="hidden" id="c_parent" value="societyC" /></td>
...
$insertGoTo = "societyC_list.php?pageNum=0&totalRows_RecsocietyC=".($_SESSION['totalRows']+1)."&changeSort=1&now_c_id=".$new_data_num."&change_num=1";
if (isset($_SERVER['QUERY_STRING'])) {
