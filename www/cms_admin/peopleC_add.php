                  ...
                  <table width="100%" border="0" cellspacing="3" cellpadding="5">
                   <tr>
                     ...
                     <td width="532"><input name="c_title" type="text" class="table_data" id="c_title" size="50">
                      <input name="c_parent" type="hidden" id="c_parent" value="peopleC" /></td>
                      <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                    </tr>

                     <tr>
                      <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">英文slogan</td>
                      <td width="532"><textarea name="c_content_en" cols="50" rows="8" class="table_data" id="c_content_en"></textarea></td>
                      <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                    </tr>

                    <tr>
                      <td width="200" align="center" bgcolor="#e5ecf6" class="table_col_title">中文slogan</td>
                      <td width="532"><textarea name="c_content" cols="50" rows="8" class="table_data" id="c_content"></textarea></td>
                      <td width="250" bgcolor="#e5ecf6">&nbsp;</td>
                    </tr>
                    ...
                    <tr>
                     <td align="center" bgcolor="#e5ecf6" class="table_col_title"><p>上傳banner圖片</p>                    </td>
                     <td>
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertSQL = sprintf("INSERT INTO class_set (c_title, c_class, c_parent, c_content_en, c_content, c_link, c_active) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
$insertGoTo = "peopleC_list.php?pageNum=0&totalRows_RecpeopleC=".($_SESSION['totalRows']+1)."&changeSort=1&now_c_id=".$new_data_num."&change_num=1";
if (isset($_SERVER['QUERY_STRING'])) {
