                ...
                <td>
                  <table width="100%" border="0" cellspacing="3" cellpadding="5">
                   <tr>
                     ...
                     <td width="532" class="table_data"><?php echo $row_RecpeopleC['c_title']; ?>
                      <input name="c_id" type="hidden" id="c_id" value="<?php echo $row_RecpeopleC['c_id']; ?>" />
...
if ((isset($_REQUEST['c_id'])) && ($_REQUEST['c_id'] != "") && (isset($_REQUEST['delsure']))) {
 ...
 $deleteGoTo = "peopleC_list.php?delchangeSort=1";
