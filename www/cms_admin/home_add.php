...
if (isset($_SESSION['selected_homeC'])){
	$G_selected1 = $_SESSION['selected_homeC'];
}
...
<body>
  <table width="1280" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
                    ...
                    <tr>
                      ...
                      <td><label>
                        <select name="d_class2" id="d_class2">
                          ...
                          do {
                            ?>
                            <option value="<?php echo $row_RechomeC['c_id']?>"<?php if (!(strcmp($row_RechomeC['c_id'], $G_selected1))) {echo "selected=\"selected\"";} ?>><?php echo $row_RechomeC['c_title']?></option>
                            <?php
      ...
      if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
        ...
        $insertSQL = sprintf("INSERT INTO data_set (d_title, d_title_en, d_content, d_class1, d_class2, d_class3, d_class4, d_class5, d_class6, d_data1, d_data2, d_data3, d_data4, d_date, d_active) VALUES (%s, %s, %s, 'home', %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
 ...
 if($ifFile){
  ...
  //----------插入檔案資料到資料庫end----------
    ...
    $insertGoTo = "home_list.php?selected1=".$d_class2."&pageNum=0&totalRows=".($_SESSION['totalRows']+1)."&changeSort=1&now_d_id=".$new_data_num."&change_num=1";
